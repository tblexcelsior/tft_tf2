...
import data_formatters.tonometer
...
class ExperimentConfig(object):
  ...
  default_experiments = ['volatility', 'electricity', 'traffic', 'favorita', 'tonometer']
  ...
  def make_data_formatter(self):
    ...
    data_formatter_class = {
        ...
        'tonometer': data_formatters.tonometer.TonometerFormatter
    }
